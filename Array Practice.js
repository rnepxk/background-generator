...
let someArr = [1,2,4,591,392,391,2,5,10,2,1,1,1,20,20];

function organize (arr) {
	// 1) Get the index of the lowest element (DONE)
	// 2) Take out the lowest element from the original array
	// 3) Repeat step 1 with the modified array (loweset element taken out)
	let x = arr[0];
	let newArr = [];
	let count = 0; 
...
// if you enter HEX color format it returns RGB and if you enter 
